...
def main():
    ap = argparse.ArgumentParser(description='Run DCEE-CausalVerse V40 text-only story pipeline')
    ...
    # V40 convenience: if image_path is missing, we keep it empty on purpose.
